...
1. Change to this directory: `cd src/js-quickstart`
1. Run your script in watch mode. For example, if you have a file named `sandbox.js`, you can run it by entering `node --watch sandbox.js`.
1. Now, you can position your terminal and your JavaScript file side-by side and watch what happens as you edit and save your code!
</Steps>
