---
title: Static Routing with React Router 7
description: SUMMARY
sidebar:
  label: Lesson 17 ✅
draft: true
...
<Tabs syncKey='section'>
  <TabItem label='A01'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A01-Sep-2026/sk/day-17/example/lesson-17-starter ./src/lesson-17
    ```
  </TabItem>
  <TabItem label='A02'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A02-Sep-2026/sk/day-17/example/lesson-17-starter ./src/lesson-17
    ```
  </TabItem>
</Tabs>
