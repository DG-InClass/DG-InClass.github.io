...
<Tabs syncKey='section'>
  <TabItem label='A01'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A01-Sep-2026/sk/day-10/example/lesson-10-starter ./src/lesson-10
    ```
  </TabItem>
  <TabItem label='A02'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A02-Sep-2026/sk/day-10/example/lesson-10-starter ./src/lesson-10
    ```
  </TabItem>
</Tabs>
...
<LinkButton href="https://refactoringui.com/" target="_blank" icon="external">Refactoring UI</LinkButton>
