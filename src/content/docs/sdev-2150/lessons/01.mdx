...
description: SUMMARY
sidebar:
  label: 01 - JavaScript DOM Review
---
...
You can grab the starter kit code for your Workbook by running the following in the VS Code terminal at the root of your workbook.

<Tabs syncKey='section'>
  <TabItem label='A01'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A01-Sep-2026/sk/day-01/example/lesson-01-starter ./src/lesson-01
    ```
  </TabItem>
  <TabItem label='A02'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A02-Sep-2026/sk/day-01/example/lesson-01-starter ./src/lesson-01
    ```
  </TabItem>
</Tabs>
...
Get a quick lay-of-the-land by checking out the files in the starter kit.
...
View the page in the browser to see what we'll be working with today.

----

## In-Class Code Sample

This first sample of the term is a small set of semi-independent tasks we want to achieve. Basically, we're recalling how to interact with the DOM and with the end-user of the page.

<Steps>
1. Create variables to track/reference the DOM elements
...
1. Create some constants/variables and display in the DOM.
...
1. Create some functions in various styles (*Function Declaration*, Function Expression*, *Arrow Functions*). Can you name the styles shown here?
...
1. Practice a bit with arrays of objects and array processing.
...
1. Building HTML from JavaScript data (the old-fashioned way).
...
1. Building HTML the safer way - as **document fragments**.
...
1. Using **event handlers** (functions) to respond to user events.
...
1. Here, we're going to work on an ultra-simple To-Do List.
...
1. The last part is **homework** to be completed before next class.
...
- [Content | Functionality | Presentation](https://dgilleland.github.io/CPSC-1520/about/dang/#design)
