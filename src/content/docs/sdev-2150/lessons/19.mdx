...
- React Router 7's Data APIs (`loader`, `action`, `useLoaderData`) automate data fetching per route - this will be explored in a future lesson.
...
<Tabs syncKey='section'>
  <TabItem label='A01'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A01-Sep-2026/sk/day-19/example/lesson-19-starter ./src/lesson-19
    ```
  </TabItem>
  <TabItem label='A02'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A02-Sep-2026/sk/day-19/example/lesson-19-starter ./src/lesson-19
    ```
  </TabItem>
</Tabs>
