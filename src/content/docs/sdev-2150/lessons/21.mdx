---
title: Client Rendering Strategies in React
description: SUMMARY
sidebar:
  label: Lesson 21
draft: true
...
<Tabs syncKey='section'>
  <TabItem label='A01'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A01-Sep-2026/sk/day-21/example/lesson-21-starter ./src/lesson-21
    ```
  </TabItem>
  <TabItem label='A02'>
    ```ps
    pnpm dlx tiged --disable-cache --force DG-InClass/SDEV-2150-A02-Sep-2026/sk/day-21/example/lesson-21-starter ./src/lesson-21
    ```
  </TabItem>
</Tabs>
...
![CSR render trace](./21/csr-render-trace.png)
